...
<table width="102%" border="0" align=center cellpadding="0" cellspacing="1" bordercolor="#CCCCCC" bgcolor="#E2E3E4">
  <tr>
    <th class="tableHeaderText" colspan=7 height=25>会员列表</th>
  </tr>
<center>
  <%'开始分页
				Const MaxPerPage=20 
	...
	rs.open "select * from tOnlinesign order by userid desc",conn,1,1
				...
				response.write "数据库中无数据"
  				...
  				if rs.eof And rs.bof then
       				Response.Write "<p align='center' class='contents'> 还没有会员信息！</p>"
   				else
  ...
  <form name="form1" method="post" action="baoming.asp?action=del">
    <tr>
      <td width="20%" bgcolor="#FFFFFF"><div align="center">姓名</div></td>
      <td width="20%" bgcolor="#FFFFFF"><div align="center">性别</div></td>
      <td width="20%" bgcolor="#FFFFFF"><div align="center">电话/手机</div></td>
      <td width="20%" bgcolor="#FFFFFF"><div align="center">注册时间</div></td>
      <td width="20%" bgcolor="#FFFFFF"><div align="center">操作</div></td>
    </tr>
    <%do while not rs.eof%>
    <tr>
    ...
    <tr>
      ...
      <td height="20" align="left" bgcolor="#FFFFFF" ><div align="center">
        <input class="button" type="submit" name="Submit" value="删除所选">
...
<%  
	...
	Function showpage(totalnumber,maxperpage,filename)  
				...
				End If  
					...
					Response.Write "<font class='contents'> 共有"&totalnumber&"个会员信息 " 
